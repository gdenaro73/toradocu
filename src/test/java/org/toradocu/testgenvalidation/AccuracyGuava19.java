...
public class AccuracyGuava19 extends TestgenTestValidation {

	private static final String PROJECT_NAME = "guava-19.0";
  ...
  public AccuracyGuava19() {
    super(GUAVA_19_SRC, GUAVA_19_BIN, GUAVA_GOAL_DIR, PROJECT_NAME);
  }
