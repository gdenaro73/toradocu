...
public class AccuracyCommonsCollections4 extends TestgenTestValidation {

	private static final String PROJECT_NAME = "commons-collections4-4.1";
  ...
  public AccuracyCommonsCollections4() {
    super(COMMONSCOLLECTIONS_4_SRC, COMMONSCOLLECTIONS_4_BIN, COMMONSCOLLECTIONS_4_GOAL_DIR, PROJECT_NAME);
  }
