...
public class AccuracyGraphStream extends TestgenTestValidation {

	private static final String PROJECT_NAME = "gs-core-1.3";
  ...
  public AccuracyGraphStream() {
    super(GRAPHSTREAM_SRC, GRAPHSTREAM_BIN, GRAPHSTREAM_GOAL_DIR, PROJECT_NAME);
  }
