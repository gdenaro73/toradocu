...
public class AccuracyPlumeLib extends TestgenTestValidation {
	private static final String PROJECT_NAME = "plume-lib-1.1.0";
  ...
  public AccuracyPlumeLib() {
    super(PLUMELIB_SRC, PLUMELIB_BIN, PLUMELIB_GOAL_DIR, PROJECT_NAME);
  }
