...
public enum Configuration {
	...
	@Parameter(names = "--validate-tests", description = "Enable the enrichment with Toradocu assertions of the test suites generated using Evosuite's traditional search-based algorithm", arity = 1)
	private boolean validateTests = false;
	
	@Parameter(names = "--validation-tests-skip-generation", description = "Skip the generation of test suites for validation. A set of already existing test suites must be provided with the -validate-tests-backup-folder option", arity = 1)
	private boolean skipValidationTestsGeneration = false;
	
	@Parameter(names = "--validation-tests-generate-backup", description = "Enable the creation of a backup folder containing the test suites generated by Evosuite for the current experiment", arity = 1)
	private boolean validationTestsBackupGeneration = true;
	
	@Parameter(names = "--json-specifications-path", description = "Path to the JSON file containing the methods specifications", arity = 1)
	private String jsonSpecificationsPath;
	...
	/**
	 * Returns true if we want to enrich test suites generated using Evosuite's traditional search-based algorithm with Toradocu assertions
	 *
	...
	/**
	 * Returns true if tests suites should be generated for validation
	 * 
	 * @return the skipValidationTestsGeneration
	 */
	public boolean isSkipValidationTestsGeneration() {
		return skipValidationTestsGeneration;
	}

	/**
	 * Returns true if a backup copy of generated tests suites should be created 
	 * 
	 * @return the validationTestsBackupGeneration
	 */
	public boolean isValidationTestsBackupGeneration() {
		return validationTestsBackupGeneration;
	}
	...
	public String getjsonSpecificationsPath() {
		return jsonSpecificationsPath;
	}
}
